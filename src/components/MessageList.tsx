                  ...
                  >
                    {msg.message_type === 'voicenote' && msg.voicenote_url ? (
                      ...
                      <div className="flex-1 flex flex-col">
                        <p className="text-text-primary text-base leading-relaxed whitespace-pre-wrap flex-1 overflow-hidden">
                          {getPreviewText(msg.message)}
                        </p>
                        {msg.message.length > 150 && (
                          <button
                            onClick={() => openMessageModal(msg)}
                            className="text-gray-600 hover:text-gray-800 text-sm font-medium mt-2 self-start underline"
                          >
                            See more
                          </button>
                        )}
                    ...
                    <p className="text-right text-sm text-text-secondary mt-4 font-medium">
                      — {msg.name}
                    </p>
                  </article>
                ))}
